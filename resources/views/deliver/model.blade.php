<div class="modal fade" id="paidModal" tabindex="-1" role="dialog" aria-labelledby="varyModalLabel"
     style="display: none;" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="varyModalLabel">@lang("تحصيل دفعة")</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">×</span>
                </button>
            </div>
            <div class="modal-body">
                <form method="post" action="{{route('receptionist.repair.deliver.paid.save',$deliver->id)}}">
                    @csrf
                    <input type="text" hidden="" name="employee_id">
                    <div class="form-group">
                        <label for="amount">@lang("المبلغ")</label>
