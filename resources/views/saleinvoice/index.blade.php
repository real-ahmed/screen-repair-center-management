    ...
    <div class="card shadow">
        <div class="card-body">
            <div class="toolbar row mb-3">
                <div class="col">
                    <form class="form-inline" action="{{route('receptionist.sale.all')}}">
                ...
                <div class="col ml-auto">
                    <div class="dropdown float-right">
                        <a href="{{route('receptionist.sale.model')}}" class="btn btn-primary float-right ml-3"
                ...
                <table class="table table-hover">
                    ...
                    @foreach($invoices as $invoice)
                        <tr>
                            ...
                            <td>{{date_format($invoice->created_at,'m/d/y h:iA')}}</td>


                            <td>

                                <a href="{{route('receptionist.sale.details',$invoice->id)}}"
                                   class="btn btn-secondary "><i class="fa-solid fa-display"></i></a>


                                <a href="{{route('receptionist.sale.model',$invoice->id)}}"
...
@push('script')
    <script>
        (function ($) {
            ...
            var deleteAction = `{{ route('receptionist.sale.delete') }}`;
