                            ...
                            <div class="card-body">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col pr-0">
                                        ...
                                        <span CLASS="h3 mb-0 text-white">{{showAmount($cards['TodayDeduction'])}} {{$general->money_sign}}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col">
                                        ...
                                        <div class="row align-items-center no-gutters">
                                            <div class="col-auto">
                                                <span CLASS="h3 mb-0 text-white">{{showAmount($cards['TodayBonus']-$cards['TodayDeduction'])}} {{$general->money_sign}}</span>
                                            </div>
                            ...
                            <div class="card-body">
                                <div class="row align-items-center">
                                    <div class="col">
                                        ...
                                        <span class="h2 mb-0">{{showAmount($cards['MonthlyBonus'])}} {{$general->money_sign}}</span>
                    ...
                    <div class="col-md-4 mb-4">
                        <div class="card shadow">
                            <div class="card-body">
                                <div class="row align-items-center">
                                    <div class="col">
                                        <span class="h2 mb-0">{{showAmount($cards['MonthlyDeduction'])}} {{$general->money_sign}}</span>
                    ...
                    <div class="col-md-4 mb-4">
                        <div class="card shadow">
                            <div class="card-body">
                                <div class="row align-items-center">
                                    <div class="col">
                                        <span class="h2 mb-0">{{$cards['RepairTotalMonthlyCount']}}</span>
                                        <p class="small text-muted mb-0">@lang('اجمالي طلبات الصيانة(الشهر)')</p>
                                    </div>
                                    <div class="col-auto">
                ...
                <div class="card shadow">
                    <div class="card-body">
                        <div class="toolbar row mb-3">
                            <div class="col">
                                <h5 class="card-title">@lang('طلبات الصيانة')</h5>

                            </div>
                            <div class="col ml-auto">
                                <div class="dropdown float-right">
                                    <a href="{{route('repair.request.all')}}" class="btn btn-primary float-right ml-3"
                                    >@lang("عرض الكل")</a>
                                </div>
                            </div>
                        </div>
                                ...
                                @empty
                                    <tr>
                                        <td class="text-muted text-center"
                                            colspan="100%">@lang('لا توجد طلبات صيانة')</td>
                                    </tr>
                                @endforelse
